...
export default function EditSeasonPage() {
    ...
    async function loadSeasonData() {
        setLoading(true);
        try {
            const response = await fetch(`http://localhost:5000/api/seasons/${selectedYear}/weeks`);
            ...
            setMessage('Failed to load season data');
        } finally {
            setLoading(false);
        }
    }
    ...
    */
    ...
    function renderWeek(weekNum) {
        ...
        // Check if week has any scored entered
