...
* 
* NEW FEATURES:
* - Edit Season button in season view
* - Simple routing to EditSeasonPage
*/
...
// View mode: "season" | "allTime" | "editSeason"
...
// Helper to get season data in array format (handles both old and new formats)
const getSeasonArray = (year) => {
  const seasonData = data[year];
  
  // If it's already an array (old format), return it
  if (Array.isArray(seasonData)) {
    return seasonData;
  }
  
  // If it's new format, return standings if available, otherwise teams
...
// ============================================
// EDIT SEASON VIEW (Simple Component)
// ============================================
...
/**
* Simple EditSeasonPage component (inline)
* This is a placeholder - you'll want to move this to its own file
*/
